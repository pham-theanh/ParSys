// this programme is a little bit different with finalPrograme because it store
// 0 consistency of set X state s for next interaction (reused re computation of first iteration).
